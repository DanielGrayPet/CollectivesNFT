  ...
  return(
    <div>
      ...
      <div className={container}>
        ...
        <article><StaticImage src="../images/placeholder-round.png" alt="Ariel" className={imgcirc}></StaticImage></article>
        <article><StaticImage src="../images/placeholder-round.png" alt="Ariel" className={imgcirc}></StaticImage></article>
        <article className={mainwrap}><h1 className={abouthead}>Ariel Bagaev</h1><h2 className={subhead}>Marketing Team Lead</h2><p className={aboutbody}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam commodo et metus sed tincidunt. Nunc varius felis urna, a sagittis turpis convallis ut. Sed pharetra, lectus ut rhoncus faucibus, nibh nunc molestie ligula, id condimentum nunc turpis in purus. Duis ultrices pellentesque magna eget bibendum. Aliquam eget lectus vehicula, viverra tortor et, tempor augue. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed leo nisi, aliquet non eros eu, lacinia pharetra mi. Nam varius ornare nisl nec maximus.</p></article>
        <article className={mainwrap}><h1 className={abouthead}>Simon Wasser</h1><h2 className={subhead}>THE Artist</h2><p className={aboutbody}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam commodo et metus sed tincidunt. Nunc varius felis urna, a sagittis turpis convallis ut. Sed pharetra, lectus ut rhoncus faucibus, nibh nunc molestie ligula, id condimentum nunc turpis in purus. Duis ultrices pellentesque magna eget bibendum. Aliquam eget lectus vehicula, viverra tortor et, tempor augue. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed leo nisi, aliquet non eros eu, lacinia pharetra mi. Nam varius ornare nisl nec maximus.</p></article>
        <article className={mainwrap}><h1 className={abouthead}>Daniel Gray</h1><h2 className={subhead}>Project Manager</h2><p className={aboutbody}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam commodo et metus sed tincidunt. Nunc varius felis urna, a sagittis turpis convallis ut. Sed pharetra, lectus ut rhoncus faucibus, nibh nunc molestie ligula, id condimentum nunc turpis in purus. Duis ultrices pellentesque magna eget bibendum. Aliquam eget lectus vehicula, viverra tortor et, tempor augue. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Sed leo nisi, aliquet non eros eu, lacinia pharetra mi. Nam varius ornare nisl nec maximus.</p></article>
      </div>
      <Footer></Footer>
    </div>
  )
