...
import {container, wave, shapefill, cont} from './Footer.module.css'
    ...
    return (
        <footer>
            ...
            <div className={container}>
                <p className={cont}>Have questions? No worries! contact us with any platform or send us an e-mail at: <strong>Collectives.bw@gmail.com</strong></p>
            </div>
        </footer>
    )
}
